...
TEX := $(shell ls *.tex)
FOLDER = /home/saul/Insync/sauld@cimat.mx/Google Drive/UNISON/Ponencias/2019/xxix-semana-unison
...
NAMETAR = "$(NAMETAR1)_Beamer_XXIX-SNDM-2019.tar.gz"
NAMEZIP = "$(NAMETAR1)_Beamer_XXIX-SNDM-2019.zip"
#main.aux
pdflatex: talk.tex
	pdflatex --synctex=1 talk.tex
	./biblio.sh
	pdflatex --synctex=1 talk.tex
	pdflatex --synctex=1 talk.tex
